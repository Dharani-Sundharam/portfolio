...
const LightPillar = ({
  ...
  }, [webGLSupported, quality]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  if (!webGLSupported) return <div className={`light-pillar-fallback ${className}`} style={{ mixBlendMode: mixBlendMode as React.CSSProperties['mixBlendMode'] }} />;
